...
class PromptSchedule:
    ...
    def animate(self, text, max_frames, print_output, clip, start_frame, pw_a, pw_b, pw_c, pw_d, pre_text='', app_text=''):
        # Splitting the input text and creating a dictionary 'animation_prompts'
        ...
        for a in inputText:
            ...
            if len(items) == 2:
                key, value = items
                animation_prompts[key] = value

        # Convert the dictionary to a JSON string
        inputText = json.dumps(animation_prompts)
        ...
        # Assuming batch_split_weighted_subprompts and other functions are defined elsewhere
